        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8     sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('revenue')" :active="request()->routeIs('revenue')">
                        {{ __('Revenue') }}
                    </x-nav-link>
                    <x-nav-link :href="route('expenses')" :active="request()->routeIs('expenses')">
                        {{ __('Expenses') }}
                    </x-nav-link>
                    <x-nav-link :href="route('treasury')" :active="request()->routeIs('treasury')">
                        {{ __('Treasury') }}
                    </x-nav-link>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        ...
                        <x-dropdown-link :href="route('revenue')">
                            {{ __('revenue') }}
                        </x-dropdown-link>
                        <x-dropdown-link :href="route('treasury')">
                            {{ __('treasury') }}
                        </x-dropdown-link>
