<nav x-data="{ open: false }" class="bg-gray-900 border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('treasury.index')" :active="request()->routeIs('treasury.index')">
                        {{ __('Treasury') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('treasury.index')" :active="request()->routeIs('treasury.index')">
                {{ __('Treasury') }}
            </x-responsive-nav-link>
